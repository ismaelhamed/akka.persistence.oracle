...
let product = "Akka.Persistence.Oracle"
let configuration = "Release"

// Metadata used when signing packages and DLLs
let signingName = "Akka.Persistence.Oracle"
let signingDescription = "Akka.Persistence support for Oracle ODP.NET"
let signingUrl = "https://github.com/ismaelhamed/akka.persistence.oracle"
...
Target "CreateNuget" (fun _ ->    
    let projects = !! "src/**/*.csproj" 
                   ...
                   -- "src/**/*Tests*.csproj"
                   -- "src/**/*Benchmark.csproj" // Don't publish benchmark
